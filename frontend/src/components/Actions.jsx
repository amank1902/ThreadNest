...
//   const [liked, setLiked] = useState(false); // Initialize to false
  ...
  // Initialize liked state when post_ changes
//   useEffect(() => {
//     if (post_) {
//       setPost(post_);
//       setLiked(post_.likes.includes(user?._id)); // Set liked based on post_
//     }
//   }, [post_]);
